...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-graph-004-erd-s-hajnal-conjecture-da06ff0c-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/GRAPH-004"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-graph-004-erd-s-hajnal-conjecture-da06ff0c-v1",
      "problem_contract_sha256": "b7eda3a793dca8daf2b3e914ebd6c06cf87f032d6ce92842aba4fa54c970ada6",
      "problem_id": "problem:um-graph-004-erd-s-hajnal-conjecture-da06ff0c",
      "route_id": "route:um-graph-004-erd-s-hajnal-conjecture-da06ff0c-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-graph-004-erd-s-hajnal-conjecture-da06ff0c-source-fidelity-01",
      "graph_id": "graph:um-graph-004-erd-s-hajnal-conjecture-da06ff0c-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-graph-004-erd-s-hajnal-conjecture-da06ff0c-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-graph-004-erd-s-hajnal-conjecture-da06ff0c-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "For any fixed graph $H$, do $H$-free graphs contain large cliques or independent sets?"
          },
          "statement_sha256": "276eed5d501c88b9edf0536fa53c1b1718e978f2757e71c814f454aa142e4487"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-graph-004-erd-s-hajnal-conjecture-da06ff0c-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-graph-004-erd-s-hajnal-conjecture-da06ff0c-root",
      "route_id": "route:um-graph-004-erd-s-hajnal-conjecture-da06ff0c-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "domain": {
      "description": "Source-native Graph Theory problem. Mathematical objects and notation are exactly those explicitly present in the frozen source statement.",
      "objects": [
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-graph-004-726f79eb8c63",
        "url": "https://www.unsolvedmath.com/problems/GRAPH-004"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
